...
const data = [
  ...
  { x: new Date(2018, 9, 17), y: 150 },
  { x: new Date(2018, 10, 1), y: 170 },
  { x: new Date(2018, 10, 2), y: 180 },
...
const scaleLabel = scaleQuantile().domain([0, 100]).range([100, 200, 300]);
...
export default class ReportAnotherScreen extends React.Component {
...
// export default connect()(ReportAnotherScreen);
